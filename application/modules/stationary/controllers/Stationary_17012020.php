    ...
    //**************** For transaction/collection Section ****************//
        ...
        public function addNewCollection()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $mode              =       $_POST['mode'];
                $ref_no            =       $_POST['ref_no'];
                $amount            =       $_POST['col_amount'];
                $remarks           =       $_POST['remarks'];
                
                $this->StationaryM->addNewCollection($trans_dt, $order_no, $bill_no, $mode, $ref_no, $amount, $remarks, $created_by, $created_dt );
        ...
        public function editBillCollection($sl_no, $bill_no)
        {

            $this->load->view('post_login/main');

            $editData['data'] = $this->StationaryM->f_get_billCollection_editData($sl_no, $bill_no);  
            $editData['project'] = $this->StationaryM->f_get_billCollectionEdit_project($sl_no, $bill_no);  
            $editData['saleAmount'] = $this->StationaryM->f_get_billCollectionEdit_saleAmount($sl_no, $bill_no);  
        ...
        public function updateCollection()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->StationaryM->updateCollection($sl_no, $trans_dt, $order_no, $bill_no, $mode, $ref_no, $amount, $remarks, $modified_by, $modified_dt );
        ...
        {
            $this->StationaryM->deleteBillCollection($sl_no, $bill_no);
            $this->collection();
    ...
    // ******************** For Transaction / Payment ********************** //
        ...
        public function addNewPayment()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->StationaryM->addNewPayment($trans_dt, $order_no, $bill_no, $part, $mode, $ref_no, $amount, $remarks, $created_by, $created_dt );
        ...
        public function editBillPayment($sl_no, $bill_no)
        {

            $this->load->view('post_login/main');

            $editData['data'] = $this->StationaryM->f_get_payment_editData($sl_no, $bill_no);      
            ...
            $editData['supplier'] = $this->StationaryM->f_get_payment_supplier_editData($order_no->order_no); 
            $editData['project'] = $this->StationaryM->f_get_payment_project_editData($order_no->order_no); 
        ...
        public function updateBillPayment()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->StationaryM->updateBillPayment($sl_no, $trans_dt, $order_no, $bill_no, $part, $mode, $ref_no, $amount, $remarks, $modified_by, $modified_dt );
        ...
        public function deleteBillPayment($sl_no, $bill_no)
        {
            ...
            $this->StationaryM->deleteBillPayment($sl_no, $bill_no);
            $this->payment();
