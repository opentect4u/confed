            ...
            <?php foreach($data as $key){ ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="col_amount" class="form-control required" id="col_amount" value= "<?php echo $key->amount; ?>" required >
                ...
                <div class="form-group row">
                    ...
                    <div id= "refNo">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="ref_no" value= "<?php echo $key->ref_no; ?>" class="form-control required" id="ref_no" >
